...
public class organization {
	...
	public static void main(String[] args){
		Manager Manager1= new Manager(1,"RAJAN",100000,5000);
		Labour Labour1= new Labour(2,"Rak",30000,2000);
		Manager Manager2= new Manager(1,"Aaron",70000,3000);
		Labour Labour2= new Labour(1,"Manu",30000,1500);
